                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="number" id="sort_orer" name="sort_orer" value="{{ old('sort_orer') }}"
                                        class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                            </div>
                            <div class="p-2 w-1/2 mx-auto">
                            ...
                            <x-selecet-image :images="$images" name="image1" />
                            <x-selecet-image :images="$images" name="image2" />
                            <x-selecet-image :images="$images" name="image3" />
                            <x-selecet-image :images="$images" name="image4" />
                            <x-selecet-image :images="$images" name="image5" />
                            <div class="p-2 w-1/2 mx-auto">
